 ...
 * @author killer
 */
public class Gh_how extends javax.swing.JFrame {

    /**
     * Creates new form Gh_how
     */
    String bc;
    public Gh_how(String aa) {
        initComponents();
        bc=aa;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("            WellCome to Pakado-Pakado");
    ...
    private void howActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_howActionPerformed
        l.setText("--> This is Single player game.");
        l2.setText("--> our robot will give u the goal..");
        l3.setText("--> ur work is to reach that place by using buttons"); 
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Gh_how.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Gh_how("uppy").setVisible(true);
            }
        });
    }
